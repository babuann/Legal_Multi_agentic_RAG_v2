...
print(similarities)
# tensor([[1.0000, 0.9026, 0.6531],
#         [0.9026, 1.0000, 0.7100],
#         [0.6531, 0.7100, 1.0000]])
```
...
* Size: 1,502 training samples
* Columns: <code>damaged_sentence</code> and <code>sentence</code>
* Approximate statistics based on the first 1000 samples:
  |         | damaged_sentence                                                                   | sentence                                                                           |
  |:--------|:-----------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------|
  | type    | string                                                                             | string                                                                             |
  | details | <ul><li>min: 5 tokens</li><li>mean: 17.95 tokens</li><li>max: 176 tokens</li></ul> | <ul><li>min: 9 tokens</li><li>mean: 39.38 tokens</li><li>max: 256 tokens</li></ul> |
* Samples:
  | damaged_sentence                                                                                                                                     | sentence                                                                                                                                                                                                                                                                                                                                  |
  |:-----------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  | <code>Court of the FACEBOOK, PETITIONERS v. AMALGAMATED ET</code>                                                                                    | <code>23-980 In the Supreme Court of the United States FACEBOOK, INC., ET AL., PETITIONERS v. AMALGAMATED BANK, ET AL.</code>                                                                                                                                                                                                             |
  | <code>CERTIORARI TO OF APPEALS FOR THE BRIEF LIPSHUTZ MORAN MEEKS VAN DUNN & Connecticut Avenue,</code>                                              | <code>ON WRIT OF CERTIORARI TO THE UNITED STATES COURT OF APPEALS FOR THE NINTH CIRCUIT BRIEF FOR THE PETITIONERS JOSHUA S. LIPSHUTZ KATHERINE MORAN MEEKS TRENTON VAN OSS GIBSON, DUNN & CRUTCHER LLP 1050 Connecticut Avenue, N.W.</code>                                                                                               |
  | <code>Washington, BRIAN M. KAHN J. FUSTER GIBSON, & CRUTCHER Center, Suite 94111 KANNON SHANMUGAM of Record T. GODI JAKE KRAMER GARRISON 2001</code> | <code>Washington, DC 20036 BRIAN M. LUTZ MICHAEL J. KAHN PATRICK J. FUSTER GIBSON, DUNN & CRUTCHER LLP One Embarcadero Center, Suite 2600 San Francisco, CA 94111 KANNON K. SHANMUGAM Counsel of Record WILLIAM T. MARKS MATTEO GODI JAKE L. KRAMER ANNA P. LIPIN PAUL, WEISS, RIFKIND, WHARTON & GARRISON LLP 2001 K Street, N.W.</code> |
